...
class UserAddStationCollectionHandler(tornado.web.RequestHandler):
    ...
    def post(self):
        ...
        # 创建 request 对象
        request = ProtobufAPI.UserAddStationCollectionRequest()
        ...
        model = Model('UserAddStationCollection')
