...
class CheckFreeStateForStationHandler(tornado.web.RequestHandler):
    ...
    def post(self):
        ...
        # 创建 request 对象
        request = ProtobufAPI.CheckFreeStateForStationRequest()
        ...
        model = Model('CheckFreeStateForStation')
