...
class CusRongCloudTokenIncorrectHandler(tornado.web.RequestHandler):
    ...
    def post(self):
        ...
        # 创建 request 对象
        request = ProtobufAPI.CusRongCloudTokenIncorrectRequest()
        ...
        model = Model('CusRongCloudTokenIncorrect')
