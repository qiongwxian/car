...
class UploadViolationQueryCarInfoHandler(tornado.web.RequestHandler):
    ...
    def post(self):
        ...
        # 创建 request 对象
        request = ProtobufAPI.UploadViolationQueryCarInfoRequest()
        ...
        model = Model('UploadViolationQueryCarInfo')
