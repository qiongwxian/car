...
class GetUserViolationQueryCarInfoHandler(tornado.web.RequestHandler):
    ...
    def post(self):
        ...
        # 创建 request 对象
        request = ProtobufAPI.GetUserViolationQueryCarInfoRequest()
        ...
        model = Model('GetUserViolationQueryCarInfo')
